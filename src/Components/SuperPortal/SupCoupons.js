                                                    ...
                                                    <div className="col-md-6  px-2 w-100 p-0 ">
                                                        <FormControl component="fieldset">
                                                            ...
                                                            <RadioGroup defaultValue="two-phase" className="d-inline" aria-label="phase" name="customized-radios">
                                                                <FormControlLabel value="feedback" onChange={(e) => setPhase(e.target.value)} control={<StyledRadio />} label="Feedback" />
                                                                <FormControlLabel value="Promotional Sale" onChange={(e) => setPhase(e.target.value)} control={<StyledRadio />} label="Promotional Sale" />
                                                            </RadioGroup>
                                                        </FormControl>
                                                    </div>
                                                    <div className="col-md-6  px-2 w-100 p-0 ">
                                                        <FormControl component="fieldset">
                                                            ...
                                                            <RadioGroup defaultValue="two-phase" className="d-inline" aria-label="phase" name="customized-radios">
                                                                <FormControlLabel value="percentage" onChange={(e) => setCoupontype(e.target.value)} control={<StyledRadio />} label="Percentage" />
                                                                <FormControlLabel value="flat" onChange={(e) => setCoupontype(e.target.value)} control={<StyledRadio />} label="Flat" />
                                                            </RadioGroup>
                                                        </FormControl>
                                                    </div>
